...
// TODO Stanley: 6/1/2018 STEP 3 and 4 Checks whether the data is consistent in the copy if it is not read from the replica
...
// TODO Stanley: 6/1/2018 STEP 3/4 or 5/6 read
                                String returnBucketPostClass = BucketAndPost.createBucketAndPost(consistentReplica);//ler o dado consistent na Amazon
                                System.out.println("S3 Get result | TEXT FILE PARSING: " + returnBucketPostClass);

// TODO Stanley: 6/1/2018 Measure and persist times
...
// TODO Stanley: 6/15/2018 Say to Client Reader has done
                                //-       clientReader.invocaComando(connectionUuid,
                                //-            ReaderWriterCommand.CONSISTENT
                                //-         ,idDoDado);//, replica
